...
public class ImagesModule {
    ...
    @Provides
    @Singleton
    ImagesRepository providesImagesRepository(edu.galileo.android.twitterclient.lib.base.EventBus eventBus, CustomTwitterApiClient client){
        return new ImagesRepositoryImpl(eventBus, client);
    }

    @Provides
    @Singleton
    CustomTwitterApiClient providesCustomApiClient(Session session){
